...
if __name__ == "__main__":
    ...
    #     Q_td, policy_td = td_sarsa(env, iterations=10000, gamma=0.9, alpha=0.5)
    #     test_performance(env, policy_td)

    # for i in range(10):
    #     print("\n" + "-" * 25 + "\nBeginning Revised Q-learning\n" + "-" * 25)
    #     Q_ql, policy_ql = qlearning(env, iterations=10000, gamma=0.9, alpha=0.5)
    #     test_performance(env, policy_ql)
